...
Features
- Scan QR codes from fuel receipts  
...
2. Opens the app  
3. Scans QR code from the receipt  
4. Transaction is recorded and discount is applied  

---

Screenshots

1. [Splash Screen](./screenshots/1_splashscreen.jpg)
